class TelefonesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @telefone.save
        format.html { redirect_to telefone_url(@telefone), notice: "Telefone was successfully created." }
  ...
  def update
    respond_to do |format|
      if @telefone.update(telefone_params)
        format.html { redirect_to telefone_url(@telefone), notice: "Telefone was successfully updated." }
  ...
  private
    ...
    def telefone_params
      params.require(:telefone).permit(:numero, :tipo, :proponente_id)
    end
end
