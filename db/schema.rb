...
ActiveRecord::Schema[7.1].define(version: 2024_06_07_234026) do
  ...
  create_table "telefones", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["proponente_id"], name: "index_telefones_on_proponente_id"
  end

  add_foreign_key "enderecos", "proponentes"
  add_foreign_key "telefones", "proponentes"
end
